...
namespace CsvFile
{
    ...
    public abstract class CsvFileCommon
    {
        ...
        /// </summary>
        private protected char[] SpecialChars = new char[] { ',', '"', '\r', '\n' };
    ...
    public sealed class CsvFileWriter : CsvFileCommon, IDisposable
    {
        ...
        public void WriteRow(List<string> columns)
        {
            ...
            {
                OneQuote = String.Format(Provider, "{0}", Quote);
                TwoQuotes = String.Format(Provider, "{0}{0}", Quote);
                QuotedFormat = String.Format(Provider, "{0}{{0}}{0}", Quote);
            }
